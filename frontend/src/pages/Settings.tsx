            ...
            <div>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', margin: '0.4rem 0 0' }}>
                {user?.lastfm_username
                  ...
                  : (isEs
                    ? 'Conecta Last.fm para scrobblear y mostrar tu música en vivo desde Spotify, Apple Music o YouTube Music.'
                    : 'Connect Last.fm to scrobble and display your live listening activity from Spotify, Apple Music or YouTube Music.')}
              </p>
            </div>
