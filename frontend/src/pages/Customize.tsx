              ...
              >
                {isLastFmLoading && !nowPlaying ? (
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', width: '100%' }}>
                    <div style={{ width: '48px', height: '48px', borderRadius: '8px', background: 'rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'flex-end', gap: '3px', height: '22px' }}>
                        ...
                        `}</style>
                        <span style={{ width: '3.5px', background: activeProfileTheme.accent, opacity: 1, borderRadius: '2px', animation: 'eqWave 1s ease-in-out infinite', animationDelay: '0s' }} />
                        <span style={{ width: '3.5px', background: activeProfileTheme.accent, opacity: 0.85, borderRadius: '2px', animation: 'eqWave 1s ease-in-out infinite', animationDelay: '0.2s' }} />
                        <span style={{ width: '3.5px', background: activeProfileTheme.accent, opacity: 0.7, borderRadius: '2px', animation: 'eqWave 1s ease-in-out infinite', animationDelay: '0.4s' }} />
                        <span style={{ width: '3.5px', background: activeProfileTheme.accent, opacity: 0.55, borderRadius: '2px', animation: 'eqWave 1s ease-in-out infinite', animationDelay: '0.15s' }} />
                      </div>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', minWidth: '180px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: activeProfileTheme.accent, opacity: 0.7, animation: 'pulse 2s infinite' }} />
                      ...
                      <span style={{ fontSize: '0.72rem', color: 'var(--text-secondary)', textTransform: 'uppercase', fontWeight: 600, letterSpacing: '0.05em', display: 'flex', alignItems: 'center', gap: '0.4rem', lineHeight: 1.2 }}>
                        {nowPlaying.is_playing ? (
                          <>
                            ...
                            {isEs ? 'Escuchando ahora' : 'Now Playing'}
                          </>
                        ) : (
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    <div style={{ width: '36px', height: '36px', borderRadius: '8px', background: activeProfileTheme.border, display: 'flex', alignItems: 'center', justifyContent: 'center', color: activeProfileTheme.accent }}>
                      <Music size={18} />
                    </div>
